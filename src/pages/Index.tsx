...
const Index = () => {
  ...
  <Link to="/booking">
    <Button
      variant="spa"
      size="lg"
      className="shadow-2xl text-lg px-12 py-6 h-auto bg-[#0000006e]! border-0!"
    >
      احجز الآن
    </Button>
  </Link>
  ...
  <Link to="/shop">
    <Button
      variant="outline"
      size="lg"
      className="shadow-2xl text-lg px-12 py-6 h-auto border-0! bg-[#0000006e]! text-white hover:bg-white hover:text-primary"
    >
      المتجر
    </Button>
  </Link>
